...
export default function Embudo() {
  return (
    <div>
      <div className="page-header"><div><h1 className="page-title">Embudo</h1><p className="page-subtitle">Funnel de ventas</p></div></div>
      <div className="flex flex-col items-center justify-center py-20" style={{ color: "hsl(var(--muted-foreground))" }}>
        ...
        <p className="text-lg font-medium">Módulo de Embudo</p>
